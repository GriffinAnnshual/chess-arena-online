			...
			<motion.div
				...
				{navItems.map((navItem: any, idx: number) =>
					pathname.includes(navItem.link) ? (
						<button className="border font-medium relative border-neutral-200 dark:border-white/[0.2] text-black dark:text-white px-4 py-2 flex items-center rounded-full">
